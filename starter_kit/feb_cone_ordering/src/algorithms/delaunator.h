...
/**
 * delaunator generates the delaunay triangulation for a set of points extremely quickly
 */
...
public:
    ...
    [[nodiscard]] double get_hull_area() const;
...
private:
    ...
    [[nodiscard]] std::size_t hash_key(double x, double y) const;
...
inline double Delaunator::get_hull_area() const {
