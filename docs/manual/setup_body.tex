...
\texttt{docs/starter-kit.md} describes what it does. Whatever stack you run, \cmd{./feb-sim logs -f}
in a second terminal shows the devkit's log: the package build, the bridge, and every line
your nodes print.
