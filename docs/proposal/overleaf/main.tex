...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$1{,}952}: a
complete car with the RPLidar S2 at this month's sale price (\$1{,}996 at list), on the camera the
team already has; \$1{,}597 without the S2; \$3{,}199 for the official reference build. Every item is listed
...
Camera: RealSense D435i, provided by a member (334 if bought) & 0 & 0 & 334 \\
Screws, standoffs, zip ties & 85 & 85 & 85 \\
Spares allowance & 60 & 60 & 60 \\
\midrule
\textbf{Total} & \textbf{1{,}597} & \textbf{1{,}996} & \textbf{3{,}199} \\
\bottomrule
\end{tabularx}
...
not \$249). The RealSense D435i is provided by a team member outside this budget; bought
new it would add \$334. The S2 is \$399 at list and \$355 on sale this month, which makes the
S2 build \$1{,}952. The Fiesta VXL
...
\href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435i.html}{Intel RealSense D435i}, provided by a team member (the official part and the FSAE car's camera; 334.00 at the RealSense store if the club ever buys its own) & member & 0 \\
...
\midrule
\textbf{Now plus S2 at list} & & \textbf{1{,}996} \\
\textbf{Now plus S2 at this month's sale price (354.99)} & & \textbf{1{,}952} \\
\bottomrule
\end{longtable}
\normalsize
...
total: \$1{,}419 now, \$1{,}818 with the S2. It is what many student builds use, but it does not match
...
over; a team member provides one, so it costs the club nothing (\$334 if bought). A
...
\begin{itemize}
  ...
  \item \textbf{RealSense D435i.} A team member's unit; the RC car's camera, on two screws, so it comes off for their own projects.
