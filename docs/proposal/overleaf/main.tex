...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$2{,}328 in parts, about \$2{,}678 with tax, shipping and duty}: a complete car
...
Sales tax, shipping and import duty, estimated at 15\% & 296 & 356 & 480 \\
\midrule
\textbf{All in} & \textbf{2{,}269} & \textbf{2{,}728} & \textbf{3{,}679} \\
\bottomrule
\end{tabularx}
...
and shipping; the 15\% line covers Alameda County sales tax (10.25\%) on everything, the
overseas shipping from Trampa, Seeed and Ambimat, and the import duty DigiKey adds to the
camera (its checkout showed \$455 for the camera alone). The Fiesta VXL
...
Tax, shipping and duty, estimated at 15\% of the S2 build & & 349 \\
\textbf{All in, S2 build at the sale price} & & \textbf{2{,}678} \\
\bottomrule
\end{longtable}
\normalsize
