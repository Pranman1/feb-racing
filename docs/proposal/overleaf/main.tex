...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$2{,}401 in parts, \$2{,}750 with sales tax, shipping and duty}: a complete car with
the RPLidar S2 and a RealSense camera bought new; \$2{,}052 in parts (\$2{,}365 all in) without the
...
Camera: RealSense D435IF from the RealSense store, tax and shipping included & 455 & 455 & 334 \\
Screws, standoffs, zip ties & 85 & 85 & 85 \\
Spares allowance & 60 & 60 & 60 \\
\midrule
\textbf{Parts} & \textbf{2{,}052} & \textbf{2{,}401} & \textbf{3{,}199} \\
Sales tax, 10.25\% on the US-shipped items (camera already taxed) & 123 & 159 & 287 \\
Shipping and duty: VESC from the UK 75, power board from India 70, domestic post 45 & 190 & 190 & 190 \\
\midrule
\textbf{All in} & \textbf{2{,}365} & \textbf{2{,}750} & \textbf{3{,}677} \\
\bottomrule
\end{tabularx}
...
bought new from the RealSense store: the D435IF, \$354 list, \$455 at checkout with tax and
shipping, and that all-in figure is what the table carries. Every other line is the shop's
list price, with tax and shipping shown separately: Alameda County sales tax at 10.25\% on
the US-shipped items, and a shipping and duty line for the two parts that come from abroad
(the VESC from the UK: post, the 10\% tariff and the carrier's brokerage fee, about \$75; the
power board from India, about \$70) plus domestic post from McMaster, Adafruit and NVIDIA.
The S2 is bought from a US seller on Amazon, so it carries tax only. The Fiesta VXL
...
\href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435if.html}{Intel RealSense D435IF} (the official D435i with an IR-pass filter, so depth also works outdoors and on the FSAE car; in stock; 354.00 list, 455.00 at checkout with tax and shipping, the only line shown all in) & RealSense & 455.00 \\
...
\midrule
\textbf{Now plus S2, parts} & & \textbf{2{,}401} \\
Sales tax, 10.25\% on the US-shipped items (1{,}551 taxable; the camera is already taxed) & & 159 \\
Shipping and duty: VESC from the UK 75, power board from India 70, domestic post 45 & & 190 \\
\textbf{All in, now plus S2} & & \textbf{2{,}750} \\
\textbf{All in, without the S2} & & \textbf{2{,}365} \\
\bottomrule
\end{longtable}
\normalsize
...
total: \$1{,}874 now, \$2{,}223 with the S2, in parts. It is what many student builds use, but it does not match
