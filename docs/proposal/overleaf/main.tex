...
Lidar: LDS-01 (owned) / \href{https://www.slamtec.com/en/Lidar/S2}{RPLidar S2} / \href{https://www.robotshop.com/en/hokuyo-ust-10lx-scanning-laser-rangefinder.html}{Hokuyo UST-10LX} & 0 & 400 & 1{,}200 \\
...
lidar we own and a Pi. \textbf{Recommended} is the official build with a time-of-flight
...
\midrule
LDS-01 (owned) & 0 & 5~Hz & 3.5~m & laps at 1 to 1.5~m/s; walls in a 2~m corridor are always in range; no useful map \\
\href{https://www.slamtec.com/en/Lidar/A1}{RPLidar A1M8} & 100 & 5 to 10~Hz & 12~m & proves the pipeline; 1\textdegree{} resolution \\
...
\begin{itemize}
  \item \textbf{LDS-01 lidar.} Onto the RC car for the first month: slow laps until the S2 arrives.
  \item \textbf{RoboSense M1 3D lidar.} Not for the RC car: 0.7~kg, half-metre blind zone, 120\textdegree{} view. It is an FSAE sensor; with the Xavier it forms a perception rig for cone-track data this semester.
...
\begin{itemize}
  ...
  \item \textbf{Speed.} 1 to 1.5~m/s on the LDS-01, about 3~m/s on the S2, faster only with the Hokuyo. The simulator car goes faster; members will feel the gap.
