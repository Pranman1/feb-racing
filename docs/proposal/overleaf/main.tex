...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$2{,}328 in parts, about \$2{,}794 with tax, shipping and duty}: a complete car
with the RPLidar S2 at this month's sale price (\$2{,}372 in parts at list) and a RealSense camera
bought new; \$1{,}973 in parts without the S2; \$3{,}199 for the official reference build. Every item is listed
...
Camera: RealSense D435IF, DigiKey & 376 & 376 & 334 \\
Screws, standoffs, zip ties & 85 & 85 & 85 \\
Spares allowance & 60 & 60 & 60 \\
\midrule
\textbf{Parts total} & \textbf{1{,}973} & \textbf{2{,}372} & \textbf{3{,}199} \\
Sales tax, shipping and import duty, estimated at 20\% & 395 & 474 & 640 \\
\midrule
\textbf{All in} & \textbf{2{,}368} & \textbf{2{,}847} & \textbf{3{,}839} \\
\bottomrule
\end{tabularx}
...
bought new, the D435IF from DigiKey at \$376. The S2 is \$399 at list and \$355 on sale this
month, which makes the S2 build \$2{,}328 in parts. All prices are shop list prices before tax
and shipping. The 20\% line is an estimate: Alameda County sales tax (10.25\%) on the
US-shipped items, about \$190; shipping, tariff and brokerage on the VESC from the UK, about
\$70; the camera's duty and shipping, about \$80 (DigiKey's checkout showed \$455 for it);
the power board from India, \$70 to \$110; and the S2, \$30 if Seeed ships it from their US
warehouse or up to \$130 with the China tariff if not. Since the small-parcel duty exemption
ended in August 2025 every foreign parcel pays its tariff, so the true figure lands between
20 and 26\% depending on that warehouse. The Fiesta VXL
...
\href{https://www.digikey.com/en/products/result?keywords=99C9LT}{Intel RealSense D435IF with cable, DigiKey 99C9LT} (the official D435i with an IR-pass filter, so depth also works outdoors and on the FSAE car; in stock, ships next day; DigiKey adds import duty and shipping at checkout, about \$80, covered by the tax and shipping line. The \href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435i.html}{RealSense store} lists the plain D435i at 334 but on backorder) & DigiKey & 376.25 \\
...
\midrule
\textbf{Now plus S2 at list} & & \textbf{2{,}372} \\
\textbf{Now plus S2 at this month's sale price (354.99)} & & \textbf{2{,}328} \\
Tax, shipping and duty, estimated at 20\% of the S2 build & & 466 \\
\textbf{All in, S2 build at the sale price} & & \textbf{2{,}794} \\
\bottomrule
\end{longtable}
\normalsize
...
total: \$1{,}796 now, \$2{,}195 with the S2. It is what many student builds use, but it does not match
...
FSAE car; \$376 from DigiKey before duty. A
