...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$2{,}407}: a
complete car with the RPLidar S2 at this month's sale price (\$2{,}451 at list) and a RealSense
camera bought new; \$2{,}052 without the S2; \$3{,}199 for the official reference build. Every item is listed
...
Camera: RealSense D435IF, DigiKey, duty and shipping included & 455 & 455 & 334 \\
Screws, standoffs, zip ties & 85 & 85 & 85 \\
Spares allowance & 60 & 60 & 60 \\
\midrule
\textbf{Total} & \textbf{2{,}052} & \textbf{2{,}451} & \textbf{3{,}199} \\
\bottomrule
\end{tabularx}
...
bought new: the D435IF from DigiKey, \$376 list plus the import duty and shipping DigiKey adds
at checkout, \$455 all in. The S2 is \$399 at list and \$355 on sale this month, which makes
the S2 build \$2{,}407. The Fiesta VXL
...
\href{https://www.digikey.com/en/products/result?keywords=99C9LT}{Intel RealSense D435IF with cable, DigiKey 99C9LT} (the official D435i with an IR-pass filter, so depth also works outdoors and on the FSAE car; 376.25 list, 455 with the import duty and shipping DigiKey adds at checkout; in stock, ships next day. The \href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435i.html}{RealSense store} lists the plain D435i at 334 but on backorder) & DigiKey & 455.00 \\
...
\midrule
\textbf{Now plus S2 at list} & & \textbf{2{,}451} \\
\textbf{Now plus S2 at this month's sale price (354.99)} & & \textbf{2{,}407} \\
\bottomrule
\end{longtable}
\normalsize
...
total: \$1{,}874 now, \$2{,}273 with the S2. It is what many student builds use, but it does not match
...
FSAE car; \$455 from DigiKey with duty and shipping. A
