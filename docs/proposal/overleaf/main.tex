...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$2{,}300 in parts, \$2{,}750 with sales tax, shipping and duty}: a complete car with
the RPLidar S2 and a RealSense camera bought new; \$1{,}951 in parts (\$2{,}366 all in) without the
S2; \$3{,}199 in parts for the official reference build. Every item is listed
...
Joystick & 30 & 30 & 30 \\
Lidar: RPLidar A1M8 (owned) / RPLidar S2 / Hokuyo UST-10LX & 0 & 349 & 1{,}200 \\
Camera: RealSense D435IF from the RealSense store & 354 & 354 & 334 \\
Screws, standoffs, zip ties & 85 & 85 & 85 \\
Spares allowance & 60 & 60 & 60 \\
\midrule
\textbf{Parts} & \textbf{1{,}951} & \textbf{2{,}300} & \textbf{3{,}199} \\
Sales tax, 10.25\% on the US-shipped items & 160 & 195 & 287 \\
Shipping and duty: VESC from the UK 75, power board from India 70, camera 65, domestic post 45 & 255 & 255 & 255 \\
\midrule
\textbf{All in} & \textbf{2{,}366} & \textbf{2{,}750} & \textbf{3{,}742} \\
\bottomrule
\end{tabularx}
...
not \$249). The team had a RealSense last year and no longer has it, so the camera is
bought new from the RealSense store, the D435IF at \$354 (its checkout total of \$455
is that price plus tax and \$65 of shipping, which sit in the two lines below the parts).
Every line is the shop's list price, with tax and shipping shown separately: Alameda County
sales tax at 10.25\% on the US-shipped items, and a shipping and duty line for the two parts
that come from abroad (the VESC from the UK: post, the 10\% tariff and the carrier's
brokerage fee, about \$75; the power board from India, about \$70), the camera's shipping,
and domestic post from McMaster, Adafruit and NVIDIA. The S2 is bought from a US seller on
Amazon, so it carries tax only. The Fiesta VXL
...
reference RealSense in its IR-filtered variant.
...
\href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435if.html}{Intel RealSense D435IF} (the official D435i with an IR-pass filter, so depth also works outdoors and on the FSAE car; in stock; checkout shows 455.00 with tax and shipping, counted in the lines below) & RealSense & 354.00 \\
...
\midrule
\textbf{Now, parts} & & \textbf{1{,}951} \\
\midrule
\multicolumn{3}{l}{\textbf{Upgrades}} \\
\href{https://www.amazon.com/dp/B0G4M3J1L8}{RPLidar S2, 30~m time of flight} (Slamtec listing, in stock, ships within the US; \href{https://www.seeedstudio.com/RPLiDAR-S2-Low-Cost-360-Degree-Laser-Range-Scanner-30M-Range-p-5198.html}{Seeed} 398.99 with a US-warehouse option and \href{https://www.robotshop.com/products/rplidar-s2-360-laser-scanner-30-m}{RobotShop} are the fallbacks) & Amazon & 349.00 \\
\midrule
\textbf{Now plus S2, parts} & & \textbf{2{,}300} \\
Sales tax, 10.25\% on the US-shipped items (1{,}905 taxable; the VESC and power board are not) & & 195 \\
Shipping and duty: VESC from the UK 75, power board from India 70, camera 65, domestic post 45 & & 255 \\
\textbf{All in, now plus S2} & & \textbf{2{,}750} \\
\textbf{All in, without the S2} & & \textbf{2{,}366} \\
\bottomrule
\end{longtable}
\normalsize
...
total: \$1{,}773 now, \$2{,}122 with the S2, in parts. It is what many student builds use, but it does not match
...
is the official part and the FSAE car's camera, so the same driver and calibration carry
over. The team had one last year and no longer does, so the budget buys the D435IF variant:
the same camera with an infrared-pass filter, which keeps depth usable in sunlight for the
FSAE car; \$354 at the RealSense store, \$455 with tax and shipping. A
\href{https://www.amazon.com/dp/B006JH8T3S}{Logitech C920}, \$67, would do the RC car's cone
job alone if the camera had to be cut.
...
\begin{itemize}
  ...
  \item \textbf{RealSense D435i.} The team had one last year; it is no longer with the team, so the budget replaces it.
