...
\usepackage{enumitem}
\raggedbottom
% keep a heading with the start of its section (the needspace trick, no package needed)
\newcommand{\Needspace}[1]{\par\vskip 0pt plus #1\penalty-100\vskip 0pt plus -#1}
...
what the stack needs: about \$900 for an Orin NX 16~GB or about \$2{,}000 for an AGX Orin.
It is not part of this ask, and buying it now would mean guessing. Two-year total,
recommended RC build now plus the FSAE computer next year: about \$2{,}750 with an Orin NX,
about \$3{,}850 with an AGX Orin.
