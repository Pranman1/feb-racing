...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$1{,}555 now}, a
complete car on the RPLidar we already own, plus \textbf{\$400 for the lidar upgrade} when
funds allow (\$1{,}954 together); \$3{,}199 for the official reference build. Every item is listed
...
Motor controller: Flipsky Mini FSESC 4.20 / VESC 6 MkVI, cables, adapters & 98 & 98 & 276 \\
...
\midrule
\textbf{Total} & \textbf{1{,}555} & \textbf{1{,}954} & \textbf{3{,}199} \\
\bottomrule
\end{tabularx}

\smallskip
Prices are what the shops showed on 24 September 2026 (Section~\ref{sec:bom}).
\textbf{Now} is the official build with the lidar we own, a webcam and a cheaper motor
controller: a complete car that drives laps at 1 to 2~m/s. \textbf{With S2} adds the
...
step by step, with three substitutions: our RPLidar for the Hokuyo, a 3S-capable Flipsky for
the VESC~6, and a webcam for the RealSense until we know whether we own one.
...
\href{https://www.amazon.com/dp/B08725X8CT}{Flipsky Mini FSESC 4.20 50~A} (3S to 13S; \href{https://flipsky.net}{flipsky.net} 85, 56 on sale) & Amazon & 71.99 \\
...
\midrule
\textbf{Now plus S2} & & \textbf{1{,}954} \\
\textbf{Now with the D435i instead of the C920} & & \textbf{1{,}821} \\
\textbf{Now plus S2, with the D435i} & & \textbf{2{,}220} \\
\bottomrule
\end{longtable}
\normalsize
...
\textbf{Fitting \$1{,}800 with the S2.} Today's sale prices (S2 at 355, controller at 56 from
Flipsky) bring the S2 build to about \$1{,}894. Swapping the power board for a
\href{https://www.pololu.com/product/2851}{Pololu 5~V 5~A regulator} (32.95) for the lidar,
with the Jetson fed from the balance extender through the barrel lead, saves \$112 more and
costs one evening of soldering plus the fuse and switch. The clean option is to buy the S2 as
a second, later request: the car does not wait for it.
