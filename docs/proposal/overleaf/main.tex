...
One 1:10-scale autonomous car on the RoboRacer (F1TENTH) standard: \textbf{\$1{,}734 now}, a
complete car on the RPLidar we already own, plus \textbf{\$400 for the lidar upgrade} when
funds allow (\$2{,}133 together); \$3{,}199 for the official reference build. Every item is listed
...
\midrule
Chassis, batteries, charger, bag & 508 & 508 & 508 \\
...
Camera: Logitech C920 / RealSense D435i & 67 & 67 & 334 \\
Screws, standoffs, zip ties & 85 & 85 & 85 \\
Spares allowance & 60 & 60 & 60 \\
\midrule
\textbf{Total} & \textbf{1{,}734} & \textbf{2{,}133} & \textbf{3{,}199} \\
\bottomrule
\end{tabularx}

\smallskip
Prices are what the shops showed on 24 September 2026 (Section~\ref{sec:bom}).
\textbf{Now} is the official build with the lidar we own and a webcam: a complete car
that drives laps at 1 to 2~m/s. \textbf{With S2} adds the
...
not \$249). If the RealSense D435i turns up in the lab, the camera line is \$0; if we buy
one instead of the webcam, add \$267. Laser cutting and 3D printing (deck, antenna mount,
...
Amazon was checked line by line and used wherever it was cheaper (the chassis is \$399 there
against \$430 from Traxxas). The list follows the
...
step by step, with two substitutions: our RPLidar for the Hokuyo, and a webcam for the
RealSense until we know whether we own one. The motor controller is the reference VESC~6.
...
\href{https://www.amazon.com/dp/B0D5M8D2R8}{Traxxas Ford Fiesta ST Rally VXL, 74276-4} (\href{https://traxxas.com/products/landing/fiesta-st-rally-vxl/}{Traxxas} 429.95; brushless motor, servo and radio included) & Amazon & 399.00 \\
...
\href{https://www.amazon.com/dp/B006JH8T3S}{Logitech C920 webcam} (colour for cone classes; buy only if the RealSense is not found) & Amazon & 67.39 \\
...
\href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435i.html}{Intel RealSense D435i} in place of the C920 (the official part and the FSAE camera; out of stock at the store today; \href{https://www.amazon.com/dp/B07BLS5477}{Amazon} lists the D435 at 519) & RealSense & 334.00 \\
\midrule
\textbf{Now plus S2} & & \textbf{2{,}133} \\
\textbf{Now with the D435i instead of the C920} & & \textbf{2{,}000} \\
\textbf{Now plus S2, with the D435i} & & \textbf{2{,}399} \\
\bottomrule
\end{longtable}
\normalsize
...
motor leads, battery to controller through the EC5 to XT60 adapter, balance lead to the power
...
total: \$1{,}556 now, \$1{,}955 with the S2. It is what many student builds use, but it does not match
...
\Needspace{10\baselineskip}
\subsection*{Camera}
The cone pipeline needs colour; range comes from the lidar. A
\href{https://www.amazon.com/dp/B006JH8T3S}{Logitech C920}, \$67, does that and is what the
budget lists. The \href{https://store.realsenseai.com/buy-intel-realsense-depth-camera-d435i.html}{RealSense D435i},
\$334, is the official part and the FSAE car's camera, so the same driver and calibration
carry over; first check whether the team already has one.
...
\begin{itemize}
  ...
  \item \textbf{RealSense D435i, if we still have one.} Then it is the RC car's camera (it is the official part) and the webcam line drops out.
