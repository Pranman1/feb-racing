...
\caption{One-on-one AI racing on Spielberg: the starter kit (leading, chase and top-down views) against the house racer. Both cars run unchanged competitor images behind the harness proxy.}
\end{figure}
