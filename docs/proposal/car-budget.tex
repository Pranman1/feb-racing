...
We ask for \textbf{\$1{,}750} to build one 1:10-scale autonomous car and a cardboard lab
track, with a minimum configuration at \textbf{\$1{,}100} if the budget is tighter. It uses
the sensors the team already owns where they fit. The car is the
...
\begin{itemize}
  ...
  the nearest are the large 8S trucks: the Traxxas X-Maxx, the Arrma Kraton 8S and the Losi
  5IVE-T. With the owned M1 and the Alameda track counted, a 1:5 build
