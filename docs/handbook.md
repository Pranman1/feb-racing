...
One document for both roles. Printable manuals: `docs/manual/competitor.pdf` (all platforms), `docs/manual/competitor_mac.pdf` (macOS, every step from an empty Mac) and `docs/manual/organiser.pdf` (LaTeX source alongside). Detail pages: `starter-kit.md`, `tracks.md`, `competition.md`,
