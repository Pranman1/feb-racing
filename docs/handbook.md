...
One document for both roles. Printable manuals: `docs/manual/competitor.pdf` (the full competitor manual: platform, rules, learning path), the three setup manuals `docs/manual/competitor_setup_{mac,windows,linux}.pdf` (install to first autonomous lap, one system each) and `docs/manual/organiser.pdf` (LaTeX source alongside). Detail pages: `starter-kit.md`, `tracks.md`, `competition.md`,
...
| Ports | 4567 member devkit, 8765 its Foxglove bridge, 4568+ harness containers (one per car), 4580 harness proxy, 4565/4566 launcher proxy and opponent |
